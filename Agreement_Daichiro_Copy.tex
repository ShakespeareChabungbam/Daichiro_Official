...
% Copy retained by: Daichiro Professional Skills Academy (Client)
% Compile with: pdflatex Agreement_Daichiro_Copy.tex
% ============================================================================
...
\fancyhead[R]{%
  \footnotesize\color{muted}\textsf{Copy retained by: Daichiro Professional Skills Academy (Client)}%
}
...
\begin{center}
  {\color{white!50}\footnotesize\sffamilyCOPY RETAINED BY: DAICHIRO PROFESSIONAL SKILLS ACADEMY (CLIENT)}\\[12pt]
